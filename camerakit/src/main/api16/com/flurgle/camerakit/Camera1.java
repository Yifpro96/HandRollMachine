...
public class Camera1 extends CameraImpl implements Camera.PreviewCallback {
...
//                    });
                    ...
                    // 自己添加空的回调
                    mCameraListener.onPictureTaken((byte[]) null);
    ...
    void initResolutions() {
        ...
        List<Size> previewSizes = sizesFromList(supportedPreviewSizes);
    ...
    private void openCamera() {
        try {
            ...
            adjustCameraParameters();
            int displayOrientation = calculatePreviewRotation();
            mCamera.setDisplayOrientation(displayOrientation);

            // 把旋转的角度回调出来
            mCameraProperties.setDisplayOrientation(displayOrientation);
...
//            return (mCameraInfo.orientation - mDisplayOrientation + 360+180) % 360;
    ...
    private int calculateCaptureRotation() {
        ...
        if (mCameraInfo.facing == Camera.CameraInfo.CAMERA_FACING_FRONT) {
            //Front is flipped
            return (previewRotation + 180 + 180 + 2 * mDisplayOrientation + 720) % 360;
    ...
    private void adjustCameraParameters() {
        ...
        synchronized (mCameraLock) {
            ...
            mPreview.setTruePreviewSize(
                    invertPreviewSizes ? previewResolution.getHeight() : previewResolution.getWidth(),
                    invertPreviewSizes ? previewResolution.getWidth() : previewResolution.getHeight()
            );
