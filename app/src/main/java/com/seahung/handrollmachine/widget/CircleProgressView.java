...
public class CircleProgressView extends View {
    ...
    protected void initByAttributes(TypedArray attributes) {
        finishedColor = attributes.getColor(R.styleable.CircleProgressView_circle_finished_color, default_finished_color);
        unfinishedColor = attributes.getColor(R.styleable.CircleProgressView_circle_unfinished_color, default_unfinished_color);
        textColor = attributes.getColor(R.styleable.CircleProgressView_circle_text_color, default_text_color);
        textSize = attributes.getDimension(R.styleable.CircleProgressView_circle_text_size, default_text_size);

        setMax(attributes.getFloat(R.styleable.CircleProgressView_circle_max, default_max));
        setProgress(attributes.getFloat(R.styleable.CircleProgressView_circle_progress, 0f));

        if (attributes.getString(R.styleable.CircleProgressView_circle_prefix_text) != null) {
            setPrefixText(attributes.getString(R.styleable.CircleProgressView_circle_prefix_text));
        }
        if (attributes.getString(R.styleable.CircleProgressView_circle_suffix_text) != null) {
            setSuffixText(attributes.getString(R.styleable.CircleProgressView_circle_suffix_text));
        }
    }
